...
#Region "Custom Subroutines"
    Private Sub DeletePatient()
        ...
        If msgReply = Windows.Forms.DialogResult.Yes Then
            Close()
            My.Computer.FileSystem.DeleteDirectory(Form1.pathPatients & selectedPatient, FileIO.DeleteDirectoryOption.DeleteAllContents)
            Form1.FlowLayoutPanel2.Controls.Clear()
            Form1.LoadPatients()
        End If
    End Sub
#End Region
    ...
    Private Sub Form3_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        Dim sReader As New System.IO.StreamReader(Form1.pathStorage & "Pasien\" & selectedPatient & "\patientInfo.txt")
        ...
        PictureBox1.Load(Form1.pathStorage & "Pasien\" & selectedPatient & "\imgPatient.png")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Form4.TextBox1.SelectionStart = Form4.TextBox1.TextLength : Form4.Show(Form1) : Close()
    End Sub
