...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If String.IsNullOrWhiteSpace(TextBox1.Text) Or String.IsNullOrWhiteSpace(MaskedTextBox1.Text) Or String.IsNullOrWhiteSpace(MaskedTextBox2.Text) Then
            MessageBox.Show("Make sure that all data have been entered.", "Buat Akun - Sistem Rawat Inap Rumah Sakit", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        Else
            If MaskedTextBox1.Text <> MaskedTextBox2.Text Then
                MessageBox.Show("The passwords you entered do not match.", "Buat Akun - Sistem Rawat Inap Rumah Sakit", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Else
                Dim sWriter As New System.IO.StreamWriter(Form1.pathAccount & "username.txt")
                sWriter.Write(TextBox1.Text)
                sWriter.Close()
                sWriter = New System.IO.StreamWriter(Form1.pathAccount & "password.txt")
