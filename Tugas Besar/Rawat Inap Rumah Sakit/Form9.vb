...
#Region "Custom Subroutines"
    Private Sub DeleteAppointment()
        ...
        If msgReply = Windows.Forms.DialogResult.Yes Then
            Dim pathToRemove As String = Form1.pathAppointments & lblPatientName.Text & " - " & lblCaseType.Text
...
#End Region
    ...
    Private Sub Form9_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        'Load data
        Dim sReader As New System.IO.StreamReader(Form1.pathAppointments & selectedAppointment & "\appointmentData.txt")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        sReader.Close()
        Close()
        If Form5.Visible = False Then Form5.Show(Form1)
