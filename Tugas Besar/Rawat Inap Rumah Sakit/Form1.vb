...
#End Region
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        MsgBox("Produk: Sistem Rawat Inap Rumah Sakit" & vbNewLine & vbNewLine & "Version: 1.0" & vbNewLine & vbNewLine & "Copyright: 2018 CODERBABA" & vbNewLine & vbNewLine & "Developer: Balram Yadav" & vbNewLine & vbNewLine & "Description: Hospital Management System is a software application that is capable of managing a hospital's patients and their appointments. The user interface is simple and clean in order to achieve maximum efficiency.")
    End Sub
    ...
    Private Sub Button14_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button14.Click, Button9.Click, Button13.Click, Button12.Click, Button11.Click, Button10.Click
        ...
        'Load selection data
        If cButton.Text = "Pasien" Then
            LoadPatients()
        ElseIf cButton.Text = "Dokter" Then
            LoadDoctors()
        ElseIf cButton.Text = "Apoteker" Then
            LoadPharmacists()
        ElseIf cButton.Text = "Perawat" Then
            LoadNurses()
        ElseIf cButton.Text = "Laboratoris" Then
            LoadLaboratorists()
        ElseIf cButton.Text = "Admin" Then
            LoadAccountants()
        End If

        'Init labels
        ToolStripLabel1.Text = "Cari " & cButton.Text.ToLower & ":"
        Label1.Text = cButton.Text & " (" & FlowLayoutPanel2.Controls.Count & ")"
        Label5.Text = "Pilihan Saat Ini: " & cButton.Text
...
Public Class Patient
    ...
    Private Sub whenClicked() Handles Me.Click
        ...
        ElseIf Me.Parent.GetContainerControl Is Form1.SplitContainer1 Then
            'Show proper form
            If Form1.selectedCategory = "Pasien" Then
                Form3.Show(Form1)
                Form3.selectedPatient = Me.Text
            ElseIf Form1.selectedCategory = "Dokter" Then
                Form10.Show(Form1)
                Form10.selectedDoctor = Me.Text
            Else
                Form11.selectedButton = Form1.selectedCategory.Substring(0, Form1.selectedCategory.Length - 1)
                Form11.Show(Form1)
...
Public Class Appointment
    ...
    Private Sub whenClicked() Handles Me.Click
        'Load data
        Dim sReader As New System.IO.StreamReader(Form1.pathAppointments & Text & "\appointmentData.txt")
