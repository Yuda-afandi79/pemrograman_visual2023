...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        # pasang Label
        Label(mainFrame, text='Masukan Alas:', border=0, width=30, font=30, background="#5F9EA0").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Masukan Tinggi:", border=0, width=30, font=30, background="#5F9EA0").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Masukan sisi 1:", border=0, width=30, font=30, background="#5F9EA0").grid(row=5, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Masukan sisi 2:", border=0, width=30, font=30, background="#5F9EA0").grid(row=7, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Masukan sisi 3:", border=0, width=30, font=30, background="#5F9EA0").grid(row=9, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas segitiga adalah:", border=0, width=30, font=30, background="#5F9EA0").grid(row=12, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="keliling segitiga adalah:", border=0, width=30, font=30, background="#5F9EA0").grid(row=14, column=0, sticky=W, padx=5, pady=5)
...
if __name__ == '__main__':  
    root = Tk() 
    aplikasi = FrmPersegi(root, "Program Luas dan keliling segitiga")
    root.mainloop()