...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Panjang:',border=0, width=10, font=30, background="#5F9EA0").grid(row=0, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Lebar:", border=0, width=10, font=30, background="#5F9EA0").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas:", border=0, width=10, font=30, background="#5F9EA0").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Keliling:", border=0, width=10, font=30, background="#5F9EA0").grid(row=4, column=0, sticky=W, padx=5, pady=5)
